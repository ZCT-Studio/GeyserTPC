...
GeyserTPC is based on [TeleportCommands](https://github.com/MrSn0wy/TeleportCommands), a teleportation mod that provides
...
Special thanks to the original author [MrSnowy](https://github.com/MrSn0wy).

This project is heavily inspired by [TeleportCommands](https://github.com/MrSn0wy/TeleportCommands), which provided the
